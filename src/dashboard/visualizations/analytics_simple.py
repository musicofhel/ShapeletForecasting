"""
Pattern Analytics Module (Simplified Version)
...
class PatternAnalytics:
    ...
    def analyze_prediction_accuracy(self, patterns: pd.DataFrame) -> Dict[str, Any]:
        ...
        tp = ((predicted['actual_direction'] == 1) & (predicted['predicted_direction'] == 1)).sum()
        tn = ((predicted['actual_direction'] == 0) & (predicted['predicted_direction'] == 0)).sum()
        fp = ((predicted['actual_direction'] == 0) & (predicted['predicted_direction'] == 1)).sum()
        fn = ((predicted['actual_direction'] == 1) & (predicted['predicted_direction'] == 0)).sum()
    ...
    def create_prediction_performance(self, patterns: pd.DataFrame) -> go.Figure:
        ...
        # 2. Confusion matrix
        tp = ((predicted['actual_direction'] == 1) & (predicted['predicted_direction'] == 1)).sum()
        tn = ((predicted['actual_direction'] == -1) & (predicted['predicted_direction'] == -1)).sum()
        fp = ((predicted['actual_direction'] == -1) & (predicted['predicted_direction'] == 1)).sum()
        fn = ((predicted['actual_direction'] == 1) & (predicted['predicted_direction'] == -1)).sum()
